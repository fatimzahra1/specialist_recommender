...
def predict():
    try:
        ...
        print("My array before processing",new_dict)
        ...
        print("My array after processing",new_dict)
        
        data = np.array(list(new_dict.values())).reshape(1, -1)

        prediction = model.predict(data)
        
        #return jsonify({'prediction': new_dict})
